...
export const ConceptionStart: React.FC = () => {
  const navigate = useNavigate();

  const handleBegin = () => {
    navigate('/wizard/conception');
  };
  ...
  const highlights = [
    {
      ...
      title: 'Ideation',
      description: 'Brainstorm features, solutions, and creative approaches to solving user problems.',
    },
    {
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
      ...
      title: 'Storyboarding',
      description: 'Visualize user flows and journeys to understand the complete user experience.',
    },
    {
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
      ...
      description: 'Clearly articulate the problem you are solving and who you are solving it for.',
    },
  ];
...
export default ConceptionStart;

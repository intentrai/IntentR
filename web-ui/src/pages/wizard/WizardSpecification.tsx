...
export const WizardSpecification: React.FC = () => {
  const [activeTab, setActiveTab] = React.useState<'capabilities' | 'enablers'>('capabilities');

  return (
    <WizardLayout>
      <div className="wizard-specification">
        <div className="wizard-specification-header">
        ...
        <div className="wizard-specification-tabs">
          <button
        ...
        <div className="wizard-specification-content">
      ...
      <style>{`
        .wizard-specification-header {
          margin-bottom: 1.5rem;
        }

        .wizard-specification-header h2 {
          font-size: 1.5rem;
          font-weight: 700;
        ...
        .wizard-specification-header p {
          color: var(--color-grey-600);
        }

        .wizard-specification-tabs {
          display: flex;
          gap: 0.5rem;
          margin-bottom: 1.5rem;
...
export default WizardSpecification;

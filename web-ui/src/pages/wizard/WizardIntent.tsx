  ...
  return (
    <WizardLayout>
      <div className="wizard-intent">
        ...
        <div className="wizard-intent-content">
      ...
      <style>{`
        .wizard-intent-header {
          margin-bottom: 1.5rem;
        }

        .wizard-intent-header h2 {
          font-size: 1.5rem;
          font-weight: 700;

...
| **Implementation** | `cmd/intentrcli/cli/shell.go` |
...
| `/config init` | - | Create `.intentrcli.yaml` in current directory | `/config init` |
...
Feature: UbeCLI Interactive Shell
  ...
  Scenario: Start interactive shell
    When I run "intentrcli" without arguments
